...
export function ReviewsSection() {
  ...
  return (
    <section id="reviews" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-cyan-50/50 to-blue-50/50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {getVisibleReviews().map((review, index) => (
            <Card key={`${currentIndex}-${index}`} className="glass-card border-0 animate-fade-in-up">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground text-pretty">"{review.text}"</p>
              </CardContent>
            </Card>
          ))}
        </div>
